...
class GKSLicenseManager extends GKSLicenseCore {
    ...
    public function css($gks_slider, $isSlider)
    {
      ...
      $scope .gks-slider-ctrl-prev,
        ...
        echo "
                width: ".($options[GKSOption::kArrowFontSize] + $arrowPadding)."px;
                height: ".($options[GKSOption::kArrowFontSize] + $arrowPadding)."px;
            }
            $scope .gks-slider-ctrl-prev i,
            $scope .gks-slider-ctrl-next i {
        ...
        echo "
            $scope .gks-slider-ctrl-prev:hover i,
            $scope .gks-slider-ctrl-next:hover i,
            $scope .gks-slider-ctrl-prev:active i,
            $scope .gks-slider-ctrl-next:active i {
        ...
        if ($isScrollerAvailable) {
          ...
          $scopeScroller.gks-scroller-layout .gks-scroller-ctrl i {
            position: absolute;
            left: 0;
            top: 50%;
            display: table-cell;
