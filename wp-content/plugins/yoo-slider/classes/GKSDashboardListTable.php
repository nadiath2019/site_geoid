...
//            'type_display'    => 'Type',
    ...
    function fetchData(){
        ...
        for($i=0; $i<count($results); $i++){
            ...
            //Build row actions
            $actions = array(
                'delete'    => sprintf('<a href="?page=%s&action=%s&id=%s" class="gks-delete-btn" onclick="if(!confirm(\'Are you sure you want to delete the slider?\')) return false;" style="float: left; margin-right: 7px; margin-top: 0px;"><i class="fa fa-minus" style="font-size: 14px;padding: 6px 0 0 6px;"></i></a>', filter_var($_REQUEST['page'], FILTER_SANITIZE_STRING),'delete',$sid),
                'options'   => sprintf('<a href="?page=%s&action=%s&id=%s&type=%s" class="gks-settings-btn" style="float: left; margin-right: 7px;"><i class="fa fa-cog fa-fw" style="font-size: 14px; padding: 5px 0 0 3px;"></i></a>', filter_var($_REQUEST['page'], FILTER_SANITIZE_STRING),'options',$sid, $type),
                'edit'      => sprintf('<a href="?page=%s&action=%s&id=%s&type=%s" class="gks-edit-btn" style="float: left; margin-right: 7px;"><i class="fa fa-pencil" style="font-size: 14px;padding: 5px 0 0 6px;"></i></a>', filter_var($_REQUEST['page'], FILTER_SANITIZE_STRING),'edit',$sid, $type),
                'duplicate' => sprintf('<a href="?page=%s&action=%s&id=%s" class="gks-duplicate-btn" style="float: left; margin-right: 7px;"><i class="fa fa-copy" style="font-size: 14px;padding: 5px 0 0 6px;"></i></a>', filter_var($_REQUEST['page'], FILTER_SANITIZE_STRING),'duplicate',$sid),
            );
